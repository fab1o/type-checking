import { customTypeCreator, objectTypeCreator } from './typeCreator';
...
export const Methods = {
    array: { singular: 'an Array', plural: 'arrays' },
    boolean: { singular: 'a Boolean', plural: 'booleans' },
    function: { singular: 'a Function', plural: 'functions' },
    string: { singular: 'a String', plural: 'strings' },
    null: { singular: 'null', plural: 'null' },
    thenable: { singular: 'a Promise', plural: 'promises' },
    date: { singular: 'a Date', plural: 'dates' },
    nonEmptyArray: {
    ...
    number: { singular: 'a Number', plural: 'numbers' },
    integer: { singular: 'an integer', plural: 'integers' },
    float: { singular: 'a float Number', plural: 'float numbers' },
    positive: {
    ...
    object: {
        ...
        plural: 'objects',
        isExpectedArgs: true,
        typeCreator: objectTypeCreator
    },
    custom: { plural: true, isExpectedArgs: true, typeCreator: customTypeCreator }
};
