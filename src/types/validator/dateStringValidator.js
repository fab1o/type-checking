 ...
 * @desc Validator for Types.dateString type that checks for an ISO date format String.
 * @returns {Boolean}
 * @note Parsing date strings with the Date constructor or Date.parse is discouraged.
 */
export function dateStringValidator(value) {
    return ISO_REG_EX.test(value);
}
