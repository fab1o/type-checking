...
var _typecheck3 = require("./typecheck.logging");
...
var _typecheck4 = require("./typecheck.atLeastOne");

Object.keys(_typecheck4).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _typecheck4[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _typecheck4[key];
    }
  });
});