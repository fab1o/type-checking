...
describe('addType - with argument', () => {
    ...
    it('adds a new type: blueberry', () => {
        ...
        expect(Types.blueberry.name).toBe('bound validate');
        expect(Types.blueberry.nullable.typeName).toBe('blueberry');
        expect(Types.blueberry.optional.typeName).toBe('blueberry');

        expect(Types.array.of.blueberry.name).toBe('bound validate');
        expect(Types.array.of.blueberry.nullable.typeName).toBe('blueberry');
    ...
    it('uses type blueberry to check for a nullable Blueberry sucessfully', () => {
        expect(() => {
    ...
    it('uses type blueberry to check for nullable array of blueberries sucessfully', () => {
        expect(() => {
